...
class Lead(db.Model):
    ...
    marketing_opt_in_at = db.Column(db.DateTime)
    marketing_opt_in_source = db.Column(db.Text)
    whatsapp_opt_in = db.Column(db.Boolean)
    opted_out = db.Column(db.Boolean, nullable=False, default=False)
    opted_out_at = db.Column(db.DateTime)
    opted_out_reason = db.Column(db.Text)
    last_marketing_message_at = db.Column(db.DateTime)
