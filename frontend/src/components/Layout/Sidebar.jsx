...
const items = [
  ...
  ["Management", "WhatsApp messages", "/communication/whatsapp", IconBrandWhatsapp, "whatsapp_messages"],
  ["Intelligence", "AI chat", "/ai-chat", IconRobot, "ai_chat"],
  ["Administration", "AI follow-ups", "/ai-followups", IconMessage, "ai_followups"],
  ["Administration", "Workflows", "/workflows", IconGitBranch, "workflows"],
  ["Administration", "Campaigns", "/campaigns", IconRocket, "campaigns"],
  ["Administration", "Reports", "/reports", IconChartBar, "reports"],
  ["Administration", "Employees", "/employees", IconUsers, "employees"],
  ["Administration", "Settings", "/settings", IconSettings, "settings"],
];
